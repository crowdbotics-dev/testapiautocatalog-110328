...
## Project Structure
    ...
    ├── testapiautocatalog_110328  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_110328`
...
2. Clone this repo and `cd testapiautocatalog_110328`
